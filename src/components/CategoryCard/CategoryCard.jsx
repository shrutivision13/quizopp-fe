    ...
    <div className="relative" key={category?._id} onClick={handleCardClick}>
          ...
          >
            {isSelected ? (
              <svg
                ...
                class="transform transition-transform duration-300 ease-in-out rotate-0"
              >
                <g filter="url(#filter0_d_9453_60829)">
                  <path
                    ...
                    class="fill-current text-C26284C"
                  ></path>
                </g>
                <path
                  ...
                  class="fill-current text-CBBBDDD"
                ></path>
                <defs>
                  <filter
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                class="transform transition-transform duration-300 ease-in-out -rotate-45"
              >
                <g filter="url(#filter0_d_9453_60829)">
                  <path
                    d="M19 29C25.6274 29 31 23.6274 31 17C31 10.3726 25.6274 5 19 5C12.3726 5 7 10.3726 7 17C7 23.6274 12.3726 29 19 29Z"
      ...
      >
        ...
        <div className="z-10 w-full flex justify-center px-10">
          <p
            className={`${captionFontSize} text-C000000 font-bold text-center`}
          >
