            ...
            <div key={article._id || index}>
              ...
              {index === 10 && (
                <Fragment>
                  ...
                  />
                  <div
                    className="px-20 pt-24 pb-20 flex justify-between cursor-pointer"
                    onClick={handleNavigate}
                  >
                    <div>
                      <div
                        data-testid="play-quiz-banner-9"
                        className="text-[18px] font-black text-C8951D9 dark:text-C4782F4"
                      >
                        Play Quiz, Win{" "}
                        <img
                          alt="coin"
