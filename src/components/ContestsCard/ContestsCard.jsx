...
const ContestsCard = ({ quizContest }) => {
  ...
  return (
    <div onClick={handelJoinContest} className="contests-card-container" key={quizContest?._id}>
        ...
        <div className="w-120 mr-20 flex">
          ...
          >
            <img
              ...
              src={`${IMAGEURL}/images/category/${quizContest?.categoryId?.categoryIcon}`}
            />
