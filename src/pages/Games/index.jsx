...
import { ApiGetContestQuestions, ApiSubmitContest } from '../../api-wrapper/contest/ApiGetcontest';
...
const Games = () => {
    ...
    const [lifelineOpen, setLifelineOpen] = React.useState(false);
    ...
    useEffect(() => {
        ApiGetContestQuestions("680a220d1b04c23b60a600e6")
            .then((response) => {
    ...
    useEffect(() => {
        if (timeLeft > 0) {
            ...
            // Time is up, handle next question or submit
    ...
    }, [timeLeft, currentQuestionIndex, questions.length, score, participantId, navigate, categoryName]);
            ...
            <div className="w-full h-full flex flex-col items-center justify-start">
                    ...
                    <div>
                        ...
                        <div className="mt-14 px-20 w-full flex items-center justify-between">
                            <div className="flex">
                                <div className="relative">
                                    <div className="relative flex items-center justify-center mb-10">
                                        <img
                                            ...
                                            decoding="async"
                                            data-nimg="1"
                                            className="rounded-[50%] style_battle_incorrect_glow_animation__0YysB"
                                            src={playerYou}
                                            style={{ color: "transparent" }}
                                        />
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="pl-10 flex flex-col text-10">
                                        ...
                                        <div className="font-bold text-CFFCC5B">Score: 0</div>
                                    </div>
                            ...
                            <div className="flex">
                                ...
                                <div className="relative">
                                    <div className="relative flex items-center justify-center mb-10 -20">
                                        <img
                                            alt="player image"
                                            loading="lazy"
                                            width="26"
                        ...
                        <div className="w-full px-20 my-14 h-4 flex items-center justify-center mb-28">
                            <div className="h-full rounded-l-10 bg-CFFD949 background-transition" style={{ width: "230%" }}></div>
                            ...
                            <div className="h-full rounded-r-10 bg-CA96DFF background-transition" style={{ width: "170%" }}></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-CFFFFFF mx-10 my-5 p-10 pt-0 border-1 rounded-10 border-CF1F1F1 shadow-quizCard dark:border-C26284C dark:bg-C20213F relative pb-30">
                    ...
                    <div className="cursor-pointer flex justify-center text-center -mt-12 z-40 absolute -bottom-16 left-1/2 -translate-x-1/2">
                        <div
                            onClick={() => setLifelineOpen((prev) => !prev)}
