...
function PlayContest() {
  const { categoryName } = useParams(); // Retrieve categoryName from the URL
  ...
  const [timeLeft, setTimeLeft] = React.useState(66);
  const [isMuted, setIsMuted] = React.useState(false);
  const [lifelineOpen, setLifelineOpen] = React.useState(false); // New state for dropdown
  const [showReportUI, setShowReportUI] = React.useState(false); // State to toggle report UI
  ...
  }, [timeLeft, currentQuestionIndex, questions.length, score, participantId, navigate, categoryName]); // Add dependencies
                    ...
                    <div className="px-20 flex w-full gap-30 justify-between transition-all ease-in duration-[250ms] overflow-hidden h-[120px] max-h-[120px] pt-14">
                      ...
                      >
                        <div className="max-w-60">
                          <div className="border rounded-full py-8 px-4 h-56 w-56 flex justify-center items-center cursor-pointer border-CFFCC5B lifeline-icon-box">
                            <div className="lifeline-icon">
                              {/* Placeholder for Freeze Timer SVG */}
                              <svg
                                width="29"
                                height="27"
                                viewBox="0 0 29 27"
                      ...
                      >
                        <div className="max-w-60">
                          <div className="border rounded-full py-8 px-4 h-56 w-56 flex justify-center items-center cursor-pointer border-CFFCC5B lifeline-icon-box">
                            <div className="lifeline-icon">
                              {/* Placeholder for Flip Question SVG */}
                              <svg
                                width="25"
                                height="25"
                                viewBox="0 0 25 25"
