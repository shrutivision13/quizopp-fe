      ...
      <div className="py-20 h-dynamic-screen hide-scroll-bar">
              ...
              >
                ...
                <div class="transform  rotate-0">
                  <svg
                    ...
                    class="fill-current text-C959595 dark:text-C8789C3"
                  >
        ...
        <div className="text-C3E51B5 text-16 font-bold text-center p-20 dark:text-CFFCC5B">
          <span
            ...
            onClick={() => setShowPrizes(!showPrizes)} // Toggle prize table visibility
          >
            View Prizes
          </span>
          ·
          <a rel className="link-anchor" href="/contest-rules">
        ...
        {showPrizes && ( // Conditionally render the prize table
          <div>
