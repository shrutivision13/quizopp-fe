...
const Footer = ({ gameStarted }) => {
    ...
    const hiddenFooterPaths = ["/login", "/login/phone", "/category", "/contest-rules", "/spin-wheel", "/begin-quiz"]; // Paths where footer should be hidden
    ...
    return (
        <div className="bg-skin-footer-dark footer-container">
            ...
            >
                <div className={`mr-10 h-30 flex items-center gap-10 ${isOpen ? 'justify-center flex-1' : ''}`}>
                    <img
                        alt="Quizzop"
                        fetchPriority="high"
                        width="100"
                ...
                <div className="block">
                    ...
                    {!gameStarted ? (
                        ...
                        <>
                            ...
                            <div className="h-1 w-full bg-C404380"></div>
                            <p data-nosnippet="true" className="px-20 py-20 text-10 text-left text-C8789C3">
                                Property ID: 4239
                            </p>
                        </>
                    )}
