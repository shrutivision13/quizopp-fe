...
const Footer = ({ gameStarted }) => {
    ...
    const hiddenFooterPaths = ["/login", "/login/phone", "/category" , "/contest-rules", "/spin-wheel",`/${categoryName}/begin-quiz`,'/mini-quiz-play' ,'/mini-quiz-over']; // Paths where footer should be hidden
